...
namespace SEA.P.Web.Hubs
{
    public class seaHub : Hub
    {
        ...
        public async Task<Models.World> WorldGetAsync(int id) => await context.Storage.Worlds.GetAsync(id);//await storage.GetTable<TableWorlds>().GetAsync(id);
        public async Task<List<Models.World>> WorldGetAllAsync() => await context.Storage.Worlds.GetAllAsync();
        public async Task<List<Models.World>> WorldGetWhereAsync(long extId) => await context.Storage.Worlds.GetWhereAsync(extId);
        public async Task<int> WorldAddAsync(Models.World world)
        {
        ...
        public async Task<List<Models.World>> WorldAddArrayAsync(List<Models.World> worldList)
        {
        ...
        public async Task<int> WorldUpdateAsync(Models.World world)
        {
            world.Title = world.Title.Trim();
